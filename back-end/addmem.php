                        ...
                        <div class="x_content">
                         ...
                         <form  data-parsley-validate=""   class="form-horizontal form-label-left"
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">录入账号 <span
                                        class="required">*</span>
                                </label>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">录入密码<span
                                        class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="p" name="password" required="required"
                                           class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
...
$(function () {
  ...
  function addapps(){
      ...
      $.post("../api/adduser.php","username="+username+"&password="+password,function(res,statue){
          res=res.trim();
          if(res=="1"){
            ShowSuccess("发布成功..")
            setTimeout(function() {
