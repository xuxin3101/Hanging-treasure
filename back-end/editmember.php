...
$(function () {
  ...
  function updatemember(){
      ...
      $.post("../api/updatemember.php","username="+username+"&idcard="+idcard+"&alipayaccount="+alipayaccount+"&name="+name+"&bankaccount="+bankaccount+"&bankplace="+bankplace+"&password="+password+"&id=<?php echo $_GET['id']; ?>",function(res,statue){
          res=res.trim();
          if(res=="1"){
            ShowSuccess("更新成功..")
            setTimeout(function() {
