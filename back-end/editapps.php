                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <button class="btn btn-success" onclick="updateapps()">更新</button>
                                </div>
                            </div>
...
$(function () {
  ...
  $.post("../api/getappdetaile.php","id=<?php echo $_GET['id']; ?>",function(res,statue){
    ...
    $("#indeximg").val(res.img);
    $("#logoimg").val(res.logo);
    $("#price").val(res.price);
  ...
  function updateapps(){
      ...
      $.post("../api/updateapp.php","title="+title+"&appname="+appname+"&img="+indeximg+"&price="+price+"&logo="+logo+"&content="+content+"&id=<?php echo $_GET['id']; ?>",function(res,statue){
          res=res.trim();
          if(res=="1"){
            ShowSuccess("更新成功..")
            setTimeout(function() {
